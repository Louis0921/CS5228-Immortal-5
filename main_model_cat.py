...
plt.plot(range(1, iterations + 1), rmse_values, linewidth=2, markersize=2, color='red')
...
feature_importance = clf.get_feature_importance(cb.Pool(train_x, label=train_y, cat_features=cat_features),
